	...
	<div class="col-xs-12">
		<div class="table-header">
			...
			<div class="pull-right"> 
				<a href="<?php echo base_url();?>pessoa/view" class="btn btn-block btn-white btn-info btn-round"><i class="ace-icon fa fa-plus green"></i>Adicionar</a>
			</div>
		</div>
		<div>
...
jQuery(function($) {
	...
	.DataTable( {
		...
		"aoColumns": [null, null, null, null, null, null,
			{"mRender": function(data, type, full) {
    				if (full[6] == '2'){
    					return '<span class="label label-sm label-warning">Jurídica</span>';
    				} else {
    					return '<span class="label label-sm label-success">Física</span>';
    				}
    			}
			}, 
			{"bSortable": false,
    			"mRender": function(data, type, full) {
    				return '<div class="hidden-sm hidden-xs action-buttons"><a class="blue" href=pessoa/view/'+ full[0] +'><i class="ace-icon fa fa-search-plus bigger-130"></i></a>'+
    				...
    				'<div class="hidden-md hidden-lg">'+ 
    					'<div class="inline pos-rel">'+
    						...
    						'<li><a href=pessoa/view/'+ full[0] +' class="tooltip-info" data-rel="tooltip" title="View"><span class="blue"><i class="ace-icon fa fa-search-plus bigger-120"></i></span></a></li>'+
        ...
        "order": [],
        "ajax": {
            "url": "<?php echo site_url('pessoa/getData')?>",
            "type": "POST",
	...
	$("button#excluir_registro").click(function(event) {
        ...
        request = $.ajax({
            url: "<?php echo base_url(); ?>pessoa/delete",
            type: "post",
            dataType: 'json',
            data: 'id='+$form
        });

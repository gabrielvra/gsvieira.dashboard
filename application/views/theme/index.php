...
<html lang="en">
	...
	<body class="no-skin">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								...
								<span class="user-info">
									...
									<?php echo $this->session->userdata('user_name_login') ?>
								</span>
							...
							<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								...
								<li>
									<a href="<?php echo base_url();?>usuario/processUsuarioExit">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content" id="divMensagem">
				<div class="main-content-inner">
					...
					<div class="page-content">
						<div class="row">
							<div class="col-xs-12">
								<div id="messages"> </div>
								<!-- AQUI COMEÇA AS PÁGINAS COM CONTEÚDO -->
								<?php
								if(isset($content)){
									$this->load->view($content);
								}
								?>
								<!-- AQUI TERMINA O CONTEÚDO DAS PÁGINAS -->
							</div><!-- /.col -->
						</div><!-- /.row -->
					</div><!-- /.page-content -->
				</div>
			...
			<?php $this->load->view('theme/rodape');?>
		</div><!-- /.main-container -->
